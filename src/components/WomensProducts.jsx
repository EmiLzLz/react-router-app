  ...
  return (
    <div className="slider-container w-full pb-8">
      <Swiper
        ...
        className="womensClothes flex cursor-grab container mx-auto overflow-hidden px-2 pt-8 pb-2 "
      >
        {data.map((product) => (
          <SwiperSlide
            key={product.id}
      ...
      <div className="pagination4 w-full flex items-center justify-center py-4" />
    </div>
  );
}
